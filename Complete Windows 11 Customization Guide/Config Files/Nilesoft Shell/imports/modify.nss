...
modify(find="Blip" pos=30)
modify(find="Copy Content to Clipboard" pos=30)
modify(find="Open in File Pilot" pos=30)
modify(find="Unlock with File Locksmith" pos=30)
modify(find="Rename with PowerRename" pos=30)
modify(find="Properties" pos=9)
