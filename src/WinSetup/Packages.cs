...
public static class Packages
{
    ...
    [
        ...
        new("Neovim", "Neovim.Neovim"),
        new("mise", "jdx.mise"),
        new("ripgrep", "BurntSushi.ripgrep.MSVC"),
        new("fd", "sharkdp.fd"),
        new("fzf", "junegunn.fzf"),
        new("bat", "sharkdp.bat"),
        new("eza", "eza-community.eza"),
        new("zoxide", "ajeetdsouza.zoxide"),
        new("Starship", "Starship.Starship"),
        new("lazygit", "JesseDuffield.lazygit"),
        new("lazydocker", "JesseDuffield.Lazydocker"),
        new("just", "Casey.Just"),
        new("jq", "jqlang.jq"),
        new("yq", "MikeFarah.yq"),
        new("tealdeer", "dbrgn.tealdeer"),
        new("dust", "bootandy.dust"),
        new("duf", "muesli.duf"),
        new("btop4win", "aristocratos.btop4win"),
        new("fastfetch", "Fastfetch-cli.Fastfetch"),
        new("yazi", "sxyazi.yazi"),
        new("shellcheck", "koalaman.shellcheck"),
        new("Gitleaks", "Gitleaks.Gitleaks"),
        new("topgrade", "topgrade-rs.topgrade"),
        new("Codex CLI", "OpenAI.Codex"),
        new("Claude Code", "Anthropic.ClaudeCode"),
        new("GitHub Copilot CLI", "GitHub.Copilot"),
        new("JetBrains Toolbox", "JetBrains.Toolbox"),
        new("CMake", "Kitware.CMake"),
        new("Ninja", "Ninja-build.Ninja"),
        new("uv", "astral-sh.uv"),
        new("fnm", "Schniz.fnm"),
        new("gsudo", "gerardog.gsudo"),
